...
export default function Contact(){
    return (
        <section id="contact" class="p-2 md:p-8 pb-8 md:pb-12 bg-gray-900 text-white">
            ...
            <p class="text-center text-base md:text-xl m-4 p-4">The best way to get involved is to join our <a href="https://discord.gg/UuNuggpKYV" class="underline" target="_blank">Discord Server</a> and attent our frequent workshops, socials, and competitions!</p>
